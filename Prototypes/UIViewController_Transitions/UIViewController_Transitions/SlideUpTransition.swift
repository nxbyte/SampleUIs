...
class SlideUpTransition: UIPresentationController, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning {
    ...
    override func presentationTransitionWillBegin() {
        ...
        presentationWrappingView = {
            $0.layer.shadowOpacity = 0.44
            $0.layer.shadowRadius = 13.0
